module Tophat.Type
  ...
  , Ty(..), PrimTy(..)
  , TyPrimUnit, TyPrimBool, TyPrimInt, TyPrimString, TyPrimList
  , Editable
  ) where
...
instance Editable a => Editable ('TyList a)
